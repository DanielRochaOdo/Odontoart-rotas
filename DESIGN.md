...
## 10. Light Mode Adaptation (Equivalent System)

This design can support a light theme while preserving the same visual grammar:
- same typography scale and weights
- same spacing and radius system
- same green accent behavior (identity marker, not background paint)
- same border-first depth logic

### Light Theme Core Palette
- **Page Canvas**: `#f6faf7`
- **Primary Surface**: `#ffffff`
- **Secondary Surface**: `#f1f6f3`
- **Tertiary Surface**: `#e9f1ed`
- **Primary Text**: `#10211a`
- **Secondary Text**: `#3f5a50`
- **Muted Text**: `#678277`
- **Subtle Border**: `#d5e1db`
- **Standard Border**: `#c4d3cb`
- **Strong Border**: `#adc1b7`
- **Brand Green**: `#3ecf8e`
- **Action Green**: `#00c573`
- **Accent Border**: `rgba(62, 207, 142, 0.34)`

### Dark-to-Light Token Mapping

| Role | Dark Value | Light Value |
|------|------------|-------------|
| Canvas | `#171717` | `#f6faf7` |
| Strong Surface | `rgba(18, 33, 43, 0.97)` | `#ffffff` |
| Surface | `rgba(20, 36, 47, 0.88)` | `#f1f6f3` |
| Soft Surface | `rgba(23, 42, 54, 0.74)` | `#e9f1ed` |
| Primary Text | `#fafafa` | `#10211a` |
| Secondary Text | `#b4b4b4` | `#3f5a50` |
| Muted Text | `#898989` | `#678277` |
| Border Subtle | `#242424` | `#d5e1db` |
| Border Standard | `#2e2e2e` | `#c4d3cb` |
| Border Strong | `#363636` | `#adc1b7` |
| Accent | `#3ecf8e` / `#00c573` | `#3ecf8e` / `#00c573` |

### Light Theme Component Specs
...
- Radius: `9999px`
- Use: Keep as high-contrast CTA in both themes
...
**Cards and Panels**
- Background: `#ffffff`
- Border: `1px solid #d5e1db` (default) or `#c4d3cb` (interactive)
- Radius: `8px` to `16px`
- Shadow: optional and minimal (`0 8px 24px -18px rgba(16, 33, 26, 0.26)`)
...
- Text: `#10211a`
- Placeholder: `#678277`
- Focus: border `#00c573` plus subtle ring `rgba(62, 207, 142, 0.2)`

**Links**
- Primary action links: `#00c573`
- Standard text links: `#10211a`
- Muted links: `#3f5a50`

### Light Theme Do and Don't

**Do**
- Keep green as a sparse signal for actions and highlights
- Keep border hierarchy as the main depth system
- Keep body text dark and high contrast on near-white surfaces
- Keep pill-vs-standard radius hierarchy unchanged

**Don't**
- Do not flood large surfaces with green tints
- Do not replace border hierarchy with heavy shadows
- Do not introduce bold-heavy typography; preserve the 400/500 weight discipline
- Do not alter hero density rules; line-height `1.00` remains the signature

## 11. Dual-Theme Token Contract (Implementation Ready)

Use a semantic token layer and switch only token values per theme:
...
:root {
  ...
  --surface-soft: #e9f1ed;
  --text: #10211a;
  --text-secondary: #3f5a50;
  --text-muted: #678277;
  --border-subtle: #d5e1db;
  --border: #c4d3cb;
  --border-strong: #adc1b7;
  --accent: #3ecf8e;
  --accent-action: #00c573;
}

.dark {
  --canvas: #171717;
  --surface-strong: rgba(18, 33, 43, 0.97);
  --surface: rgba(20, 36, 47, 0.88);
  --surface-soft: rgba(23, 42, 54, 0.74);
  --text: #fafafa;
...
This keeps component classes stable while allowing consistent light and dark rendering.
