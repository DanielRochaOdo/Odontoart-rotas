...
const AGENDA_LITE_SELECT_COLUMNS =
  "id, data_da_ultima_visita, visit_completed_vidas, cod_1:codigo, empresa, cep, pessoa, contato, perfil_visita, corte, venc, valor, reajuste_pct, endereco, complemento, bairro, cidade, uf, supervisor, vendedor, nome_fantasia, grupo, obs_comercial, situacao, categoria, visit_generated_at, created_at";
