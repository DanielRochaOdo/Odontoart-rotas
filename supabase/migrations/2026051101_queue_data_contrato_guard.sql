-- Reforco de seguranca da fila:
-- DataContrato e a unica fonte de elegibilidade da entrada na fila.
-- created_at nao pode ser usado como fallback para liberar empresa.
...
alter table public.queue_release_controls
  ...
  check (data_contrato is not null and data_contrato >= date '2026-01-01');
